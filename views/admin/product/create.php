            ...
            <div class="col-12">
                ...
                <?php if (Flash::has('create_success')): ?>
                    ...
                    <form action="<?php echo url("admin/products/create") ?>" method="POST"
                        ...
                        <div class="row mb-3">
                            <label for="in_category" class="col-sm-2 col-form-label">mô  tả ngắn</label>
                        ...
                        <div class="row mb-3">
                            <label for="floatingInput" class="col-sm-2 col-form-label">ảnh</label>
                        ...
                        <div class="row mb-3">
                            <label for="rate" class="col-sm-2 col-form-label">Kích cỡ</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            <label for="price" class="col-sm-2 col-form-label">Màu</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            <label for="weight" class="col-sm-2 col-form-label">Giá</label>
                            <div class="col-sm-10">
                                <input type="number" step="20000" class="form-control" id="price" name="price">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="weight" class="col-sm-2 col-form-label">Số lượng</label>
                            <div class="col-sm-10">
                                <input type="number" step="1" class="form-control" id="price" name="quantity">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="weight" class="col-sm-2 col-form-label">Thêm thông tin</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            <label for="in_category" class="col-sm-2 col-form-label">Thuộc Category</label>
                            <select style="width: 82%;" class="form-select col-sm-10" id="in_categories"
                                name="categories_id">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="btn btn-primary btn-sm">
                                    <input type="submit" value="Thêm" class="btn btn-primary" id="btn">
                                    <!-- <button type="submit" class="btn btn-primary"> create</button> -->
                                </div>
                                <div class="btn btn-danger btn-sm"> 
                                    <a   href="<?php echo url('admin/thongke/index') ?>">
                                        <input value="quay về  Admin" class="btn btn-danger">
                                    </a>
                                </div>
