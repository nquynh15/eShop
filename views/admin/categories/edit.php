        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <h2 class="heading-section">Cập Nhật Categories</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-10">
                                    ...
                                    <form method="POST" class="contactForm" action="<?php echo url("admin/categories/update", ['categories_id' => $id]) ?>">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <label class="label" for="name">Mô tả ngắn</label>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div>
                                                        <input type="submit" value="Cập nhật categories" class="btn btn-primary"
                                                            id="btn">
                                                        <!-- <button type="submit" class="btn btn-primary"> create</button> -->
                                                    </div>
                                                    <div>
                                                        <a href="<?php echo url('admin/thongke/index') ?>">
                                                            <input value="Quay về giao diện quản lý" class="btn btn-primary">
                                                        </a>
                                                    </div>
